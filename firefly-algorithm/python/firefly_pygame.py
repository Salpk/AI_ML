...
Textual Programming Environments"
 ...
 TWO MODES (press T to toggle):
   ...
   OPTIMIZE mode    - a real fitness landscape (Sphere or Rastrigin, toggle
                       with B) is drawn as a background heat map, and the
                       fireflies perform genuine Firefly Algorithm search on
                       it. Toggle the topology with C:
 ...
 CONTROLS
   ...
   B                       : (Optimize only) toggle Sphere / Rastrigin
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_ESCAPE:
                    ...
                    bench_name = "Sphere" if bench_name == "Rastrigin" else "Rastrigin"
                    best_value = math.inf
